...
CREATE TABLE Temperatura (
	idTemp INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
	fkAtm INT,
    	FOREIGN KEY (fkAtm)
        REFERENCES Atm (idAtm),  
   	tMin DECIMAL(3,1),
...
INSERT INTO Vendas
 ...
 INSERT INTO Atm (fkFilial, nome, maquina, sistemaOp) VALUES (10, "nomeMaquina2" , "maquina2", "sistema");
 INSERT INTO Atm (fkFilial, nome, maquina, sistemaOp) VALUES (10, "nomeMaquina3" , "maquina3", "sistema");
